        ...
        <div className="row g-4">
            ...
            <div className="offer__item">
              ...
              <div className="offer__icon">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <rect x="16" y="8" width="32" height="48" rx="4" fill="#3C72FC" />
                  <path
                    d="M32 2C30.8954 2 30 2.89543 30 4V8H34V4C34 2.89543 33.1046 2 32 2Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M32 58C30.8954 58 30 58.8954 30 60V62C30 63.1046 30.8954 64 32 64C33.1046 64 34 63.1046 34 62V60C34 58.8954 33.1046 58 32 58Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M2 32C2 30.8954 2.89543 30 4 30H8V34H4C2.89543 34 2 33.1046 2 32Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M60 32C60 30.8954 59.1046 30 58 30H54V34H58C59.1046 34 60 33.1046 60 32Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M4 4C3.44772 4 3 4.44772 3 5V8H7V5C7 4.44772 6.55228 4 6 4H4Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M60 5C60.5523 5 61 5.44772 61 6V8H57V6C57 5.44772 57.4477 5 58 5H60Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M4 60C3.44772 60 3 60.4477 3 61V63H7V61C7 60.4477 6.55228 60 6 60H4Z"
                    fill="#3C72FC"
                  />
                  <path
                    d="M60 61C60.5523 61 61 61.4477 61 62V64H57V62C57 61.4477 57.4477 61 58 61H60Z"
                    fill="#3C72FC"
                  />
                </svg>
              </div>
              <h4 className="text-white mt-20">AI</h4>
            </div>
          </div>
          ...
          >
            <div className="offer__item">
              ...
              <div className="offer__icon">
                ...
                >
                  <g clipPath="url(#clip0)">
                    <path d="M4 20V30H8V20H4Z" fill="#3C72FC" />
                    <path d="M12 12V30H16V12H12Z" fill="#3C72FC" />
                    <path d="M20 16V30H24V16H20Z" fill="#3C72FC" />
                    <path d="M28 8V30H32V8H28Z" fill="#3C72FC" />
                    <path d="M2 30H34" stroke="#3C72FC" strokeWidth="2" />
                    <path d="M2 5V30" stroke="#3C72FC" strokeWidth="2" />
                  </g>
                  <defs>
                    <clipPath id="clip0">
                      <rect width="36" height="36" fill="white" />
              ...
              <h4 className="text-white mt-20">Data Analysis</h4>
            </div>
          </div>
          <div
            className="col-lg-2 col-md-4 col-sm-6 "
          ...
          >
            <div className="offer__item">
              ...
              <h4 className="text-white mt-20">Game Dev</h4>
            </div>
          </div>
        </div>
      </div>

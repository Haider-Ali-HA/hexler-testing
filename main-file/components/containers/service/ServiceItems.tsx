...
import Two from "@/public/images/service/mobile application.png";
import Three from "@/public/images/service/software-testing.png";
import Four from "@/public/images/service/web-development.png";
import Five from "@/public/images/service/service-image4.jpg";
import Six from "@/public/images/service/devOps.png";
import Seven from "@/public/images/service/UX UI.png";
    ...
    <section id="service-items" className="service-inner-area pt-120 pb-120">
      <div className="container">
        <div className="row g-4">
          <div className="col-lg-4 col-md-6">
            <div className="service-two__item">
              ...
              <div className="service-two__content">
                ...
                <p>
                  Create responsive and engaging websites tailored to your
                  business needs, ensuring seamless user experiences across all
                  devices.
                </p>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-two__item">
              ...
              <div className="service-two__content">
                ...
                <p>
                  Craft visually stunning and user-friendly interfaces that
                  elevate user satisfaction and improve overall interaction with
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-two__item">
              ...
              <div className="service-two__content">
                ...
                <p>
                  Design and develop intuitive mobile applications that enhance
                  user engagement and streamline functionality for both iOS and
                  Android platforms.
                </p>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-two__item">
              <div className="service-image bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
              ...
              <div className="service-two__content">
                ...
                <p>
                  Ensure the highest quality standards by rigorously testing
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-two__item">
              ...
              <div className="service-two__content">
                ...
                <p>
                  Streamline your development and operational processes with
                  integrated DevOps practices that enhance collaboration and
                  accelerate delivery.
                </p>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="service-two__item">
              ...
              <div className="service-two__content">
                ...
                <p>
                  Bring imaginative concepts to life with immersive game
                  development, delivering captivating experiences across
                  multiple platforms.
                </p>
